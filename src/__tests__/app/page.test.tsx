...
describe("Landing Page", () => {
  ...
  describe("Hero Section", () => {
    it("displays the main headline", () => {
      expect(
        screen.getByRole("heading", { level: 1, name: "Marathon Training" })
      ).toBeInTheDocument();
  ...
  describe("Footer", () => {
    ...
    it("has copyright information", () => {
      expect(
        screen.getByText(
          /© 2024 Marathon Planner. Built for runners, by runners./
        )
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Visual Design Elements", () => {
    ...
    it("has consistent blue theme throughout", () => {
      ...
      const ctaSection = screen
        .getByText("Ready to Start Training?")
        .closest("section");
  ...
  describe("Content Quality", () => {
    it("has clear and compelling copy", () => {
      ...
      expect(
        screen.getByText(/detailed progress monitoring and analytics/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(
