...
jest.mock('@/components/plans/TrainingPlanView', () => {
  return function MockTrainingPlanView({ plan, onBack }: { 
...
describe('Plans [id] Page', () => {
  ...
  describe('when user is authenticated', () => {
    ...
    it('handles permission denied error', async () => {
      ...
      expect(screen.getByText('You do not have permission to view this plan')).toBeInTheDocument();
    });
  ...
  describe('when user is not authenticated', () => {
    ...
    it('shows protected route behavior', () => {
      ...
      expect(screen.queryByText('Test Marathon Training Plan')).not.toBeInTheDocument();
    });
  });
